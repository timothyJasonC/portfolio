            ...
            <div className='grid grid-cols-2 gap-6'>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col justify-center gap-4 items-center'>
                    ...
                    <div className='flex gap-4 justify-evenly items-center'>
                        ...
                        <a download="" href={'/cv.pdf'} className="text-white cursor-pointer text-lg flex gap-2 bg-black-100 p-2 px-6 rounded-full justify-center items-center">
                            Download CV
